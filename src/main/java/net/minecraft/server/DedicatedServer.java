...
public class DedicatedServer extends MinecraftServer implements IMinecraftServer {
	...
	public PropertyManager	      propertyManager;	                                 // CraftBukkit
																					 // -
																					 // private
																					 // ->
																					 // public
	...
	protected boolean init() throws java.net.UnknownHostException { // CraftBukkit
																	// - throws
		...
		this.propertyManager = new PropertyManager(this.options); // CraftBukkit
																  // - CLI
																  // argument
																  // support
		...
		if (!this.n.a()) {
			...
			i.info("Normaly I would force you too accept the EULA, but since the new EULA is shit, just go ahead.");
			// this.n.b();
			// return false;
		}
		if (this.N()) {
		...
		int gamemode = this.propertyManager.getInt("gamemode", EnumGamemode.SURVIVAL.getId()); // CraftBukkit
																							   // -
																							   // Unique
																							   // name
																							   // to
		...
		} catch (Throwable ioexception) { // CraftBukkit - IOException ->
										  // Throwable
		...
		if (!NameReferencingFileConverter.a(this.propertyManager)) {
			...
			this.convertable = new WorldLoaderServer(server.getWorldContainer()); // CraftBukkit
																				  // -
																				  // moved
																				  // from
																				  // MinecraftServer
